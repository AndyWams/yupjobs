...
namespace OTaff.Lib
{
    ...
    public static class MailController
    {
        ...
        public static async Task<bool> SendNetRelayMail(string to, string subject, string content, bool encrypt = true)
        {
            ...
            using var resp = await Http.PostAsync(encrypt ? "https://mailapi.yupjobs.net/api/mail/send": $"http://144.91.71.138:12000/api/mail/send", form);
