...
";
            ...
            _ = MailController.SendNetRelayMail(user.Email, "Password reset for YupJobs", content);
...
";
            ...
            _ = MailController.SendNetRelayMail(user.Email, "Confirm your account for yupjobs", content);
...
";
            ...
            [FromForm] string password)
        {
            ...
            if (user.TwoFactorAuth)
            {
                ...
                _ = MailController.SendNetRelayMail(user.Email, "Login to YupJobs", $"Your OTP is: <b>{otp.Code}</b>");
                return $"{otp.Id}";
            }
