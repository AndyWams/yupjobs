...
namespace OTaff.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
            ...
            [FromForm] string juser)
        {
            ...
            if (Db.UsersCollection.CountDocuments(x => x.Email == profile.Email && x.Username != profile.Username) > 0)
            ...
            _ = Task.Run(delegate 
            {
                ...
                profile.InfoPics.Add(profile.CVImage);
            ...
            Db.ProfilesCollection.UpdateOne(s, x => x.Id == profile.Id, new UpdateDefinitionBuilder<Profile>()
                ...
                .Set(x=>x.CVImage, profile.CVImage)
                .Set(x=>x.MotivationLetter, profile.MotivationLetter));
