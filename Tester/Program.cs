...
namespace Tester
{
    class Program
    {
        ...
        {
            var to = Ask<string>("Address");
            var resp = OTaff.Lib.MailController.SendNetRelayMail(to, "Subject", "Body");
        ...
        static void ClearDb()
        {
            ...
            var tls = new Task[] {
                ...
                Db.ChatFiles.DeleteManyAsync(x=>true),
                Db.IntervalPaymentOrders.DeleteManyAsync(x=>true)
